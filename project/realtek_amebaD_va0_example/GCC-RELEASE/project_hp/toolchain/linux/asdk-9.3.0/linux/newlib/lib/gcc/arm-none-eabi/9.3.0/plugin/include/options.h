...
enum opt_code
{
  ...
  OPT_Tbss_ = 145,                           /* -Tbss= */
  OPT_Tdata = 146,                           /* -Tdata */
  OPT_Tdata_ = 147,                          /* -Tdata= */
  OPT_Ttext = 148,                           /* -Ttext */
  OPT_Ttext_ = 149,                          /* -Ttext= */
  OPT_U = 150,                               /* -U */
  /* OPT_W = 151, */                         /* -W */
  OPT_Wa_ = 152,                             /* -Wa, */
  OPT_Wabi = 153,                            /* -Wabi */
  OPT_Wabi_tag = 154,                        /* -Wabi-tag */
  OPT_Wabi_ = 155,                           /* -Wabi= */
  OPT_Wabsolute_value = 156,                 /* -Wabsolute-value */
  OPT_Waddress = 157,                        /* -Waddress */
  OPT_Waddress_of_packed_member = 158,       /* -Waddress-of-packed-member */
  OPT_Waggregate_return = 159,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 160,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 161,                       /* -Waliasing */
  OPT_Walign_commons = 162,                  /* -Walign-commons */
  /* OPT_Waligned_new = 163, */              /* -Waligned-new */
  OPT_Waligned_new_ = 164,                   /* -Waligned-new= */
  OPT_Wall = 165,                            /* -Wall */
  OPT_Walloc_size_larger_than_ = 166,        /* -Walloc-size-larger-than= */
  OPT_Walloc_zero = 167,                     /* -Walloc-zero */
  OPT_Walloca = 168,                         /* -Walloca */
  OPT_Walloca_larger_than_ = 169,            /* -Walloca-larger-than= */
  OPT_Wampersand = 170,                      /* -Wampersand */
  OPT_Wargument_mismatch = 171,              /* -Wargument-mismatch */
  ...
  /* OPT_Wattribute_alias = 176, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 177,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 178,              /* -Wattribute-warning */
  OPT_Wattributes = 179,                     /* -Wattributes */
  OPT_Wbad_function_cast = 180,              /* -Wbad-function-cast */
  OPT_Wbool_compare = 181,                   /* -Wbool-compare */
  OPT_Wbool_operation = 182,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 183,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 184,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 185,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 186, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 187,                   /* -Wc++11-compat */
  OPT_Wc__14_compat = 188,                   /* -Wc++14-compat */
  OPT_Wc__17_compat = 189,                   /* -Wc++17-compat */
  /* OPT_Wc__1z_compat = 190, */             /* -Wc++1z-compat */
  ...
  OPT_Wcomment = 209,                        /* -Wcomment */
  /* OPT_Wcomments = 210, */                 /* -Wcomments */
  OPT_Wcompare_reals = 211,                  /* -Wcompare-reals */
  OPT_Wconditionally_supported = 212,        /* -Wconditionally-supported */
  OPT_Wconversion = 213,                     /* -Wconversion */
  OPT_Wconversion_extra = 214,               /* -Wconversion-extra */
  OPT_Wconversion_null = 215,                /* -Wconversion-null */
  OPT_Wcoverage_mismatch = 216,              /* -Wcoverage-mismatch */
  OPT_Wcpp = 217,                            /* -Wcpp */
  OPT_Wctor_dtor_privacy = 218,              /* -Wctor-dtor-privacy */
  OPT_Wdangling_else = 219,                  /* -Wdangling-else */
  OPT_Wdate_time = 220,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 221,    /* -Wdeclaration-after-statement */
  OPT_Wdelete_incomplete = 222,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 223,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdeprecated = 224,                     /* -Wdeprecated */
  OPT_Wdeprecated_copy = 225,                /* -Wdeprecated-copy */
  OPT_Wdeprecated_copy_dtor = 226,           /* -Wdeprecated-copy-dtor */
  OPT_Wdeprecated_declarations = 227,        /* -Wdeprecated-declarations */
  OPT_Wdesignated_init = 228,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 229,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 230,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 231,           /* -Wdiscarded-qualifiers */
  OPT_Wdiv_by_zero = 232,                    /* -Wdiv-by-zero */
  OPT_Wdo_subscript = 233,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 234,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 235,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 236,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 237,                /* -Wduplicated-cond */
  OPT_Weffc__ = 238,                         /* -Weffc++ */
  OPT_Wempty_body = 239,                     /* -Wempty-body */
  OPT_Wendif_labels = 240,                   /* -Wendif-labels */
  OPT_Wenum_compare = 241,                   /* -Wenum-compare */
  OPT_Werror = 242,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 243, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 244,                         /* -Werror= */
  OPT_Wexpansion_to_defined = 245,           /* -Wexpansion-to-defined */
  OPT_Wextra = 246,                          /* -Wextra */
  OPT_Wextra_semi = 247,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 248,                   /* -Wfatal-errors */
  OPT_Wfloat_conversion = 249,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 250,                    /* -Wfloat-equal */
  /* OPT_Wformat = 251, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 252,            /* -Wformat-contains-nul */
  OPT_Wformat_extra_args = 253,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 254,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 255, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 256,               /* -Wformat-overflow= */
  OPT_Wformat_security = 257,                /* -Wformat-security */
  OPT_Wformat_signedness = 258,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 259, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 260,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 261,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 262,             /* -Wformat-zero-length */
  OPT_Wformat_ = 263,                        /* -Wformat= */
  OPT_Wframe_address = 264,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 265,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 266,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 267,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 268,           /* -Wfunction-elimination */
  OPT_Whsa = 269,                            /* -Whsa */
  OPT_Wif_not_aligned = 270,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 271,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 272,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 273,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 274, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 275,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 276,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 277,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 278,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 279,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 280, */                   /* -Wimport */
  OPT_Wincompatible_pointer_types = 281,     /* -Wincompatible-pointer-types */
  OPT_Winherited_variadic_ctor = 282,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 283,             /* -Winit-list-lifetime */
  OPT_Winit_self = 284,                      /* -Winit-self */
  OPT_Winline = 285,                         /* -Winline */
  OPT_Wint_conversion = 286,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 287,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 288,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 289,               /* -Winteger-division */
  OPT_Wintrinsic_shadow = 290,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 291,                 /* -Wintrinsics-std */
  OPT_Winvalid_memory_model = 292,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 293,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 294,                    /* -Winvalid-pch */
  OPT_Wjump_misses_init = 295,               /* -Wjump-misses-init */
  OPT_Wl_ = 296,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 297, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 298,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 299,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 300,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 301,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 302,                     /* -Wlogical-op */
  OPT_Wlong_long = 303,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 304,              /* -Wlto-type-mismatch */
  OPT_Wmain = 305,                           /* -Wmain */
  OPT_Wmaybe_uninitialized = 306,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 307,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 308,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 309,         /* -Wmisleading-indentation */
  OPT_Wmissing_attributes = 310,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 311,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 312,           /* -Wmissing-declarations */
  OPT_Wmissing_delay_slot = 313,             /* -Wmissing-delay-slot */
  OPT_Wmissing_field_initializers = 314,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 315, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 316,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 317, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_type = 318,         /* -Wmissing-parameter-type */
  OPT_Wmissing_profile = 319,                /* -Wmissing-profile */
  OPT_Wmissing_prototypes = 320,             /* -Wmissing-prototypes */
  OPT_Wmudflap = 321,                        /* -Wmudflap */
  OPT_Wmultichar = 322,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 323,           /* -Wmultiple-inheritance */
  OPT_Wmultistatement_macros = 324,          /* -Wmultistatement-macros */
  OPT_Wnamespaces = 325,                     /* -Wnamespaces */
  OPT_Wnarrowing = 326,                      /* -Wnarrowing */
  OPT_Wnested_externs = 327,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 328, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 329, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_vla_larger_than = 330, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 331,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 332,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 333,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 334,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 335,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 336,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 337, */               /* -Wnormalized */
  OPT_Wnormalized_ = 338,                    /* -Wnormalized= */
  OPT_Wnull_dereference = 339,               /* -Wnull-dereference */
  OPT_Wodr = 340,                            /* -Wodr */
  OPT_Wold_style_cast = 341,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 342,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 343,           /* -Wold-style-definition */
  OPT_Wopenmp_simd = 344,                    /* -Wopenmp-simd */
  OPT_Woverflow = 345,                       /* -Woverflow */
  OPT_Woverlength_strings = 346,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 347,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 348,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 349,     /* -Woverride-init-side-effects */
  OPT_Wp_ = 350,                             /* -Wp, */
  OPT_Wpacked = 351,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 352,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 353,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 354,                         /* -Wpadded */
  OPT_Wparentheses = 355,                    /* -Wparentheses */
  OPT_Wpedantic = 356,                       /* -Wpedantic */
  OPT_Wpessimizing_move = 357,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 358, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 359,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 360,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 361,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 362,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 363,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 364,            /* -Wpointer-to-int-cast */
  OPT_Wpossible_load_use = 365,              /* -Wpossible-load-use */
  OPT_Wpragmas = 366,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 367,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 368,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 369,                       /* -Wprotocol */
  OPT_Wpsabi = 370,                          /* -Wpsabi */
  OPT_Wreal_q_constant = 371,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 372,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 373,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 374,                /* -Wredundant-decls */
  OPT_Wredundant_move = 375,                 /* -Wredundant-move */
  OPT_Wregister = 376,                       /* -Wregister */
  OPT_Wreorder = 377,                        /* -Wreorder */
  OPT_Wrestrict = 378,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 379,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 380,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 381,           /* -Wscalar-storage-order */
  OPT_Wselector = 382,                       /* -Wselector */
  OPT_Wsequence_point = 383,                 /* -Wsequence-point */
  OPT_Wshadow = 384,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 385, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 386,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 387, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 388,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 389, */            /* -Wshadow=global */
  OPT_Wshadow_local = 390,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 391,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 392,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 393,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 394, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 395,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 396,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 397,                /* -Wsign-conversion */
  OPT_Wsign_promo = 398,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 399,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 400,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_pointer_div = 401,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 402,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 403,                    /* -Wspeculative */
  OPT_Wstack_protector = 404,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 405,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 406,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 407,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 408,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 409,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 410,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 411,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 412,          /* -Wstrict-selector-match */
  /* OPT_Wstringop_overflow = 413, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 414,             /* -Wstringop-overflow= */
  OPT_Wstringop_truncation = 415,            /* -Wstringop-truncation */
  OPT_Wsubobject_linkage = 416,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 417,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 418,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 419,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 420,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 421,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 422,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 423,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 424,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 425,               /* -Wsuggest-override */
  OPT_Wsurprising = 426,                     /* -Wsurprising */
  OPT_Wswitch = 427,                         /* -Wswitch */
  OPT_Wswitch_bool = 428,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 429,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 430,                    /* -Wswitch-enum */
  OPT_Wswitch_unreachable = 431,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 432,                      /* -Wsync-nand */
  OPT_Wsynth = 433,                          /* -Wsynth */
  OPT_Wsystem_headers = 434,                 /* -Wsystem-headers */
  OPT_Wtabs = 435,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 436,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 437,           /* -Wtautological-compare */
  OPT_Wtemplates = 438,                      /* -Wtemplates */
  OPT_Wterminate = 439,                      /* -Wterminate */
  OPT_Wtraditional = 440,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 441,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 442,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 443,                      /* -Wtrigraphs */
  OPT_Wtype_limits = 444,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 445,            /* -Wundeclared-selector */
  OPT_Wundef = 446,                          /* -Wundef */
  OPT_Wundefined_do_loop = 447,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 448,                      /* -Wunderflow */
  OPT_Wuninitialized = 449,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 450,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 451, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 452, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 453,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 454,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 455,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 456,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 457, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 458,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 459,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 460,                /* -Wunused-function */
  OPT_Wunused_label = 461,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 462,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 463,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 464,               /* -Wunused-parameter */
  OPT_Wunused_result = 465,                  /* -Wunused-result */
  OPT_Wunused_value = 466,                   /* -Wunused-value */
  OPT_Wunused_variable = 467,                /* -Wunused-variable */
  OPT_Wuse_without_only = 468,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 469,                   /* -Wuseless-cast */
  OPT_Wvarargs = 470,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 471,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 472,   /* -Wvector-operation-performance */
  OPT_Wvirtual_inheritance = 473,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 474,            /* -Wvirtual-move-assign */
  OPT_Wvla = 475,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 476,               /* -Wvla-larger-than= */
  OPT_Wvolatile_register_var = 477,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 478,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 479,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzerotrip = 480,                       /* -Wzerotrip */
  OPT_X = 481,                               /* -X */
  OPT_Xassembler = 482,                      /* -Xassembler */
  OPT_Xf = 483,                              /* -Xf */
  OPT_Xlinker = 484,                         /* -Xlinker */
  OPT_Xpreprocessor = 485,                   /* -Xpreprocessor */
  OPT_Z = 486,                               /* -Z */
  OPT_ansi = 487,                            /* -ansi */
  OPT_aux_info = 488,                        /* -aux-info */
  /* OPT_aux_info_ = 489, */                 /* -aux-info= */
  OPT_auxbase = 490,                         /* -auxbase */
  OPT_auxbase_strip = 491,                   /* -auxbase-strip */
  OPT_c = 492,                               /* -c */
  OPT_cef = 493,                             /* -cef */
  ...
  OPT_cpp_ = 496,                            /* -cpp= */
  OPT_d = 497,                               /* -d */
  OPT_debuglib_ = 498,                       /* -debuglib= */
  OPT_defaultlib_ = 499,                     /* -defaultlib= */
  OPT_dstartfiles = 500,                     /* -dstartfiles */
  ...
  OPT_fbtr_bb_exclusive = 558,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 559,                /* -fbuilding-libgcc */
  OPT_fbuilding_libphobos_tests = 560,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 561,                        /* -fbuiltin */
  OPT_fbuiltin_ = 562,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 563,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 564,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 565,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 566,                    /* -fcall-saved- */
  OPT_fcall_used_ = 567,                     /* -fcall-used- */
  OPT_fcaller_saves = 568,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 569,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 570, */            /* -fcf-protection */
  OPT_fcf_protection_ = 571,                 /* -fcf-protection= */
  OPT_fchar8_t = 572,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 573,        /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 574, */          /* -fcheck-data-deps */
  OPT_fcheck_new = 575,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 576,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 577,                         /* -fcheck= */
  OPT_fchecking = 578,                       /* -fchecking */
  OPT_fchecking_ = 579,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 580,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 581,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 582,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 583,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 584,/* -fchkp-flexible-struct-trailing-arrays */
  ...
  OPT_fcoarray_ = 599,                       /* -fcoarray= */
  OPT_fcode_hoisting = 600,                  /* -fcode-hoisting */
  ...
  OPT_fconstexpr_loop_limit_ = 613,          /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 614,           /* -fconstexpr-ops-limit= */
  OPT_fconvert_ = 615,                       /* -fconvert= */
  OPT_fcprop_registers = 616,                /* -fcprop-registers */
  OPT_fcray_pointer = 617,                   /* -fcray-pointer */
  OPT_fcrossjumping = 618,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 619,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 620, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 621,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 622,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 623,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 624,            /* -fd-lines-as-comments */
  OPT_fdafile_relative = 625,                /* -fdafile-relative */
  ...
  OPT_fdec = 635,                            /* -fdec */
  OPT_fdec_include = 636,                    /* -fdec-include */
  OPT_fdec_intrinsic_ints = 637,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 638,                       /* -fdec-math */
  OPT_fdec_static = 639,                     /* -fdec-static */
  OPT_fdec_structure = 640,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 641,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 642,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 643,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 644, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 645,              /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 646,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 647,                /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 648,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 649,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 650,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 651,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 652,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 653,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 654,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 655,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 656, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 657,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_format_ = 658,            /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 659,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 660,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 661,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_show_caret = 662,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_labels = 663,        /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 664,  /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 665,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 666,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_template_tree = 667, /* -fdiagnostics-show-template-tree */
  OPT_fdirectives_only = 668,                /* -fdirectives-only */
  OPT_fdisable_ = 669,                       /* -fdisable- */
  OPT_fdoc = 670,                            /* -fdoc */
  OPT_fdoc_dir_ = 671,                       /* -fdoc-dir= */
  OPT_fdoc_file_ = 672,                      /* -fdoc-file= */
  OPT_fdoc_inc_ = 673,                       /* -fdoc-inc= */
  OPT_fdollar_ok = 674,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 675,         /* -fdollars-in-identifiers */
  OPT_fdruntime = 676,                       /* -fdruntime */
  OPT_fdse = 677,                            /* -fdse */
  ...
  OPT_fdump_d_original = 682,                /* -fdump-d-original */
  OPT_fdump_final_insns = 683,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 684,              /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 685,            /* -fdump-fortran-global */
  ...
  OPT_ffix_bdsl = 723,                       /* -ffix-bdsl */
  OPT_ffixed_ = 724,                         /* -ffixed- */
  OPT_ffixed_form = 725,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 726,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 727,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 728,                    /* -ffloat-store */
  OPT_ffor_scope = 729,                      /* -ffor-scope */
  /* OPT_fforce_addr = 730, */               /* -fforce-addr */
  OPT_fforward_propagate = 731,              /* -fforward-propagate */
  OPT_ffp_contract_ = 732,                   /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 733,         /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 734,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 735,                      /* -ffpe-trap= */
  OPT_ffree_form = 736,                      /* -ffree-form */
  OPT_ffree_line_length_ = 737,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 738,          /* -ffree-line-length-none */
  OPT_ffreestanding = 739,                   /* -ffreestanding */
  OPT_ffriend_injection = 740,               /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 741,      /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 742,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 743,                   /* -ffunction-cse */
  OPT_ffunction_sections = 744,              /* -ffunction-sections */
  OPT_fgcse = 745,                           /* -fgcse */
  OPT_fgcse_after_reload = 746,              /* -fgcse-after-reload */
  OPT_fgcse_las = 747,                       /* -fgcse-las */
  OPT_fgcse_lm = 748,                        /* -fgcse-lm */
  OPT_fgcse_sm = 749,                        /* -fgcse-sm */
  OPT_fgimple = 750,                         /* -fgimple */
  OPT_fgnat_encodings_ = 751,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 752,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 753,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 754,                         /* -fgnu-tm */
  OPT_fgnu_unique = 755,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 756,                   /* -fgnu89-inline */
  OPT_fgo_c_header_ = 757,                   /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 758,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 759,           /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 760,           /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 761,                /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 762,          /* -fgo-debug-escape-hash= */
  ...
  OPT_frlxcov = 1011,                        /* -frlxcov */
  OPT_frounding_math = 1012,                 /* -frounding-math */
  OPT_frtti = 1013,                          /* -frtti */
  OPT_fsanitize_address_use_after_scope = 1014,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1015,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1016,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1017,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1018,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1019,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1020,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1021,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1022, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1023,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1024,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1025,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1026,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1027,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1028,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1029,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1030,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1031,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1032,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1033,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1034,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1035,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1036,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1037,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1038,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1039, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1040,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1041,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1042,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1043,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1044,               /* -fsection-anchors */
  /* OPT_fsee = 1045, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1046,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1047,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1048,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1049,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1050,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1051,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1052,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1053,                   /* -fshort-enums */
  OPT_fshort_wchar = 1054,                   /* -fshort-wchar */
  OPT_fshow_column = 1055,                   /* -fshow-column */
  OPT_fshrink_wrap = 1056,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1057,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1058,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1059,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1060,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1061,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1062,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1063,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1064,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1065,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1066,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1067,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1068,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1069,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1070,              /* -fsplit-wide-types */
  OPT_fsquangle = 1071,                      /* -fsquangle */
  OPT_fssa_backprop = 1072,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1073,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1074,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1075,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1076, */             /* -fstack-check */
  OPT_fstack_check_ = 1077,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1078,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1079,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1080,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1081,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1082,               /* -fstack-protector */
  OPT_fstack_protector_all = 1083,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1084,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1085,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1086,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1087,                   /* -fstack-usage */
  OPT_fstats = 1088,                         /* -fstats */
  OPT_fstdarg_opt = 1089,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1090,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1091, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1092,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1093,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1094,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1095,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1096,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1097, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1098,            /* -fstrong-eval-order= */
  OPT_fsuppress_outer_loop_unroll = 1099,    /* -fsuppress-outer-loop-unroll */
  OPT_fswitch_errors = 1100,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1101,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1102,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1103,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1104, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1105,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1106, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1107,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1108, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1109,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1110,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1111,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1112,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1113,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1114,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1115,                   /* -ftime-report */
  OPT_ftime_report_details = 1116,           /* -ftime-report-details */
  OPT_ftls_model_ = 1117,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1118,              /* -ftoplevel-reorder */
  OPT_ftracer = 1119,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1120,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1121,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1122,                   /* -ftrampolines */
  OPT_ftransition_all = 1123,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1124,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1125,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1126,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1127,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1128,              /* -ftransition=field */
  OPT_ftransition_import = 1129,             /* -ftransition=import */
  OPT_ftransition_nogc = 1130,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1131,                /* -ftransition=tls */
  OPT_ftrapping_math = 1132,                 /* -ftrapping-math */
  OPT_ftrapv = 1133,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1134,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1135,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1136,                      /* -ftree-ccp */
  OPT_ftree_ch = 1137,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1138, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1139,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1140,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1141, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1142,                   /* -ftree-cselim */
  OPT_ftree_dce = 1143,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1144,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1145,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1146,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1147,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1148, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1149,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1150,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1151, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1152,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1153,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1154, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1155,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1156,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1157,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1158,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1159,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1160,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1161,                      /* -ftree-pre */
  OPT_ftree_pta = 1162,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1163,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1164, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1165,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1166,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1167,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1168,                     /* -ftree-slsr */
  OPT_ftree_sra = 1169,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1170, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1171, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1172,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1173,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1174,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1175, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1176,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1177, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1178,                      /* -ftree-vrp */
  OPT_ftword = 1179,                         /* -ftword */
  OPT_ftword_stack = 1180,                   /* -ftword-stack */
  OPT_funconstrained_commons = 1181,         /* -funconstrained-commons */
  OPT_funderscoring = 1182,                  /* -funderscoring */
  OPT_funit_at_a_time = 1183,                /* -funit-at-a-time */
  OPT_funittest = 1184,                      /* -funittest */
  OPT_funroll_all_loops = 1185,              /* -funroll-all-loops */
  OPT_funroll_loops = 1186,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1187, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1188,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1189,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1190,                 /* -funsigned-char */
  OPT_funswitch_loops = 1191,                /* -funswitch-loops */
  OPT_funwind_tables = 1192,                 /* -funwind-tables */
  OPT_fuse_balx = 1193,                      /* -fuse-balx */
  OPT_fuse_cxa_atexit = 1194,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1195,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1196,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1197,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1198,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1199,             /* -fuse-linker-plugin */
  OPT_fuse_tls = 1200,                       /* -fuse-tls */
  OPT_fuse_uls = 1201,                       /* -fuse-uls */
  OPT_fvar_tracking = 1202,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1203,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1204,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1205,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1206,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1207, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1208,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1209,                   /* -fverbose-asm */
  /* OPT_fversion = 1210, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1211,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1212,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1213,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1214,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1215,                   /* -fvisibility= */
  OPT_fvpt = 1216,                           /* -fvpt */
  OPT_fvtable_gc = 1217,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1218,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1219,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1220,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1221,                     /* -fvtv-debug */
  OPT_fweak = 1222,                          /* -fweak */
  OPT_fweb = 1223,                           /* -fweb */
  /* OPT_fwhole_file = 1224, */              /* -fwhole-file */
  OPT_fwhole_program = 1225,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1226,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1227,             /* -fworking-directory */
  OPT_fwpa = 1228,                           /* -fwpa */
  OPT_fwpa_ = 1229,                          /* -fwpa= */
  OPT_fwrapv = 1230,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1231,                 /* -fwrapv-pointer */
  OPT_fxref = 1232,                          /* -fxref */
  /* OPT_fzee = 1233, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1234,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1235,                     /* -fzero-link */
  OPT_g = 1236,                              /* -g */
  OPT_gant = 1237,                           /* -gant */
  OPT_gas_loc_support = 1238,                /* -gas-loc-support */
  OPT_gas_locview_support = 1239,            /* -gas-locview-support */
  OPT_gcoff = 1240,                          /* -gcoff */
  OPT_gcoff1 = 1241,                         /* -gcoff1 */
  OPT_gcoff2 = 1242,                         /* -gcoff2 */
  OPT_gcoff3 = 1243,                         /* -gcoff3 */
  OPT_gcolumn_info = 1244,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1245,                 /* -gdescribe-dies */
  OPT_gdwarf = 1246,                         /* -gdwarf */
  OPT_gdwarf_ = 1247,                        /* -gdwarf- */
  OPT_gen_decls = 1248,                      /* -gen-decls */
  OPT_ggdb = 1249,                           /* -ggdb */
  OPT_ggnu_pubnames = 1250,                  /* -ggnu-pubnames */
  OPT_ginline_points = 1251,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1252, /* -ginternal-reset-location-views */
  OPT_gnat = 1253,                           /* -gnat */
  OPT_gnatO = 1254,                          /* -gnatO */
  OPT_gno_ = 1255,                           /* -gno- */
  OPT_gno_pubnames = 1256,                   /* -gno-pubnames */
  OPT_gpubnames = 1257,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1258,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1259,                   /* -gsplit-dwarf */
  OPT_gstabs = 1260,                         /* -gstabs */
  OPT_gstabs_ = 1261,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1262,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1263,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1264,                        /* -gtoggle */
  OPT_gvariable_location_views = 1265,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1266,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1267,                           /* -gvms */
  OPT_gxcoff = 1268,                         /* -gxcoff */
  OPT_gxcoff_ = 1269,                        /* -gxcoff+ */
  OPT_gz = 1270,                             /* -gz */
  OPT_gz_ = 1271,                            /* -gz= */
  OPT_h = 1272,                              /* -h */
  OPT_idirafter = 1273,                      /* -idirafter */
  OPT_imacros = 1274,                        /* -imacros */
  OPT_imultiarch = 1275,                     /* -imultiarch */
  OPT_imultilib = 1276,                      /* -imultilib */
  OPT_include = 1277,                        /* -include */
  OPT_iplugindir_ = 1278,                    /* -iplugindir= */
  OPT_iprefix = 1279,                        /* -iprefix */
  OPT_iquote = 1280,                         /* -iquote */
  OPT_isysroot = 1281,                       /* -isysroot */
  OPT_isystem = 1282,                        /* -isystem */
  OPT_iwithprefix = 1283,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1284,              /* -iwithprefixbefore */
  OPT_k8 = 1285,                             /* -k8 */
  OPT_l = 1286,                              /* -l */
  OPT_lang_asm = 1287,                       /* -lang-asm */
  OPT_mabi_ = 1288,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1289,             /* -mabort-on-noreturn */
  OPT_mapcs = 1290,                          /* -mapcs */
  OPT_mapcs_frame = 1291,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1292,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1293,              /* -mapcs-stack-check */
  OPT_march_ = 1294,                         /* -march= */
  OPT_marm = 1295,                           /* -marm */
  OPT_masm_syntax_unified = 1296,            /* -masm-syntax-unified */
  OPT_mbe32 = 1297,                          /* -mbe32 */
  OPT_mbe8 = 1298,                           /* -mbe8 */
  OPT_mbig_endian = 1299,                    /* -mbig-endian */
  OPT_mbranch_cost_ = 1300,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1301,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1302,     /* -mcaller-super-interworking */
  OPT_mcmse = 1303,                          /* -mcmse */
  OPT_mcpu_ = 1304,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1305,            /* -mfix-cortex-m3-ldrd */
  OPT_mfix_vldstr = 1306,                    /* -mfix-vldstr */
  OPT_mflip_thumb = 1307,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1308,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1309,                  /* -mfp16-format= */
  OPT_mfpu_ = 1310,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1311,             /* -mgeneral-regs-only */
  /* OPT_mhard_float = 1312, */              /* -mhard-float */
  OPT_mlittle_endian = 1313,                 /* -mlittle-endian */
  OPT_mlong_calls = 1314,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1315,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1316,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1317,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1318,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1319,               /* -mprint-tune-info */
  OPT_mpure_code = 1320,                     /* -mpure-code */
  OPT_mrestrict_it = 1321,                   /* -mrestrict-it */
  OPT_msched_prolog = 1322,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1323,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1324,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1325, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1326,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1327,                         /* -mthumb */
  OPT_mthumb_interwork = 1328,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1329,                  /* -mtls-dialect= */
  OPT_mtp_ = 1330,                           /* -mtp= */
  OPT_mtpcs_frame = 1331,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1332,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1333,                         /* -mtune= */
  OPT_munaligned_access = 1334,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1335,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1336,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1337,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1338,              /* -mword-relocations */
  OPT_n = 1339,                              /* -n */
  ...
  OPT_s = 1373,                              /* -s */
  OPT_save_temps = 1374,                     /* -save-temps */
  OPT_save_temps_ = 1375,                    /* -save-temps= */
  OPT_shared = 1376,                         /* -shared */
  OPT_shared_libgcc = 1377,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1378,               /* -shared-libphobos */
  ...
  OPT_static_libgfortran = 1384,             /* -static-libgfortran */
  OPT_static_libgo = 1385,                   /* -static-libgo */
  OPT_static_liblsan = 1386,                 /* -static-liblsan */
  OPT_static_libmpx = 1387,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1388,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1389,               /* -static-libphobos */
  OPT_static_libstdc__ = 1390,               /* -static-libstdc++ */
  OPT_static_libtsan = 1391,                 /* -static-libtsan */
  OPT_static_libubsan = 1392,                /* -static-libubsan */
  OPT_static_pie = 1393,                     /* -static-pie */
  /* OPT_std_c__03 = 1394, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1395, */                /* -std=c++0x */
  OPT_std_c__11 = 1396,                      /* -std=c++11 */
  OPT_std_c__14 = 1397,                      /* -std=c++14 */
  OPT_std_c__17 = 1398,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1399, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1400, */                /* -std=c++1z */
  OPT_std_c__2a = 1401,                      /* -std=c++2a */
  OPT_std_c__98 = 1402,                      /* -std=c++98 */
  OPT_std_c11 = 1403,                        /* -std=c11 */
  OPT_std_c17 = 1404,                        /* -std=c17 */
  /* OPT_std_c18 = 1405, */                  /* -std=c18 */
  /* OPT_std_c1x = 1406, */                  /* -std=c1x */
  OPT_std_c2x = 1407,                        /* -std=c2x */
  /* OPT_std_c89 = 1408, */                  /* -std=c89 */
  OPT_std_c90 = 1409,                        /* -std=c90 */
  OPT_std_c99 = 1410,                        /* -std=c99 */
  /* OPT_std_c9x = 1411, */                  /* -std=c9x */
  OPT_std_f2003 = 1412,                      /* -std=f2003 */
  OPT_std_f2008 = 1413,                      /* -std=f2008 */
  OPT_std_f2008ts = 1414,                    /* -std=f2008ts */
  OPT_std_f2018 = 1415,                      /* -std=f2018 */
  OPT_std_f95 = 1416,                        /* -std=f95 */
  OPT_std_gnu = 1417,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1418, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1419, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1420,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1421,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1422,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1423, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1424, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1425,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1426,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1427,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1428,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1429, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1430, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1431,                      /* -std=gnu2x */
